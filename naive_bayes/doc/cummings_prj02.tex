...
Using a $m$-estimation scheme has also been performed for the binned data probabilities.  This converts the probabilities 

$$P(a_i | v_j) = \frac{n_c + mp}{n + m},$$

where $m$ is the number of bins used and $p=1/m$.
\end{document}
